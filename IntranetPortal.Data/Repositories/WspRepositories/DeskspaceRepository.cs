...
namespace IntranetPortal.Data.Repositories.WspRepositories
{
    public class DeskspaceRepository : IDeskspaceRepository
    {
        ...
        //========= Get By OwnerName and Dates =================//
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByOwnerNamenArchivednDatesAsync(string ownerName, bool IsArchived, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByOwnerNamenDatesAsync(string ownerName, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByUnitIdnLocationIdnArchivednDatesAsync(int unitId, int locationId, bool IsArchived, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByUnitIdnLocationIdnDatesAsync(int unitId, int locationId, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByUnitIdnLocationGroupIdnArchivednDatesAsync(int unitId, int locationGroupId, bool IsArchived, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
            ...
            sb.Append("FROM public.wsp_wki_fdr f ");
            sb.Append("WHERE f.emp_id IN (SELECT emp_id FROM public.erm_emp_inf WHERE unit_id = @unit_id ");
            sb.Append("AND loc_id IN (SELECT loc_id FROM public.gst_loc_grplocs WHERE loc_grp_id = @loc_grp_id)) ");
            sb.Append("AND (f.is_archived = @is_archived) AND (f.dt_frm >= @dt_frm) AND (f.dt_to <= @dt_to) ");
            sb.Append("GROUP BY emp_nm, wki_fdr_id ");
            sb.Append("ORDER BY emp_nm ASC, wki_fdr_id DESC;");
            string query = sb.ToString();
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByUnitIdnLocationGroupIdnDatesAsync(int unitId, int locationGroupId, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByDepartmentIdnLocationIdnArchivednDatesAsync(int deptId, int locationId, bool IsArchived, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByDepartmentIdnLocationIdnDatesAsync(int deptId, int locationId, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByDepartmentIdnLocationGroupIdnArchivednDatesAsync(int deptId, int locationGroupId, bool IsArchived, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByDepartmentIdnLocationGroupIdnDatesAsync(int deptId, int locationGroupId, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        //========= Get By Location Group Id and Dates =================//
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByLocationGroupIdnArchivednDatesAsync(int locationGroupId, bool IsArchived, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
            ...
            sb.Append("(SELECT COUNT(eval_hdr_id) FROM public.wsp_eval_hdr WHERE wki_fdr_id = f.wki_fdr_id) as no_of_eval ");
            sb.Append("FROM public.wsp_wki_fdr f ");
            sb.Append("WHERE f.emp_id IN (SELECT emp_id FROM public.erm_emp_inf WHERE loc_id IN ");
            sb.Append("(SELECT loc_id FROM public.gst_loc_grplocs WHERE loc_grp_id = @loc_grp_id)) ");
            sb.Append("AND (f.is_archived = @is_archived) AND (f.dt_frm >= @dt_frm) AND (f.dt_to <= @dt_to) ");
            sb.Append("GROUP BY emp_nm, wki_fdr_id ");
            sb.Append("ORDER BY emp_nm ASC, wki_fdr_id DESC;");
            string query = sb.ToString();
        ...
        public async Task<List<WorkItemFolder>> GetWorkItemFoldersByLocationGroupIdnDatesAsync(int locationGroupId, DateTime? startDate = null, DateTime? endDate = null)
        {
            List<WorkItemFolder> folderList = new List<WorkItemFolder>();
            DateTime start_date = startDate ?? DateTime.Now.AddMonths(-3);
            DateTime end_date = endDate ?? DateTime.Now.AddMonths(+3);
        ...
        public async Task<TaskItem> GetTaskItemByOwnerIdnAssignmentIdAsync(string taskOwnerId, long assignmentId)
        {
            TaskItem task = new TaskItem();
            StringBuilder sb = new StringBuilder();
            sb.Append("SELECT t.tsk_itm_id, t.tsk_itm_no, t.tsk_itm_ds, t.tsk_itm_inf, t.wki_fdr_id, ");
            ...
            sb.Append("(SELECT wki_fdr_nm FROM public.wsp_wki_fdr WHERE wki_fdr_id = t.wki_fdr_id) as wki_fdr_nm ");
            sb.Append("FROM public.wsp_tsk_itms t ");
            sb.Append("WHERE (t.tsk_owner_id=@tsk_owner_id) AND (t.assgnmt_id=@assgnmt_id); ");
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    var assgnmt_id = cmd.Parameters.Add("@assgnmt_id", NpgsqlDbType.Bigint);
                    await cmd.PrepareAsync();
                    assgnmt_id.Value = assignmentId;
        ...
        public async Task<List<TaskItem>> GetTaskItemsByOwnerIdnKeywordAsync(string ownerId, string keyword, DateTime startDate, DateTime endDate)
        {
            ...
            sb.Append("AND (t.crt_dt >= to_date(@sdt,'YYYY-MM-DD')) ");
            sb.Append("AND (t.crt_dt <= to_date(@edt,'YYYY-MM-DD')) ");
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                {
                    var tsk_owner_id = cmd.Parameters.Add("@tsk_owner_id", NpgsqlDbType.Text);
                    var kw = cmd.Parameters.Add("@kw", NpgsqlDbType.Text);
        ...
        public async Task<long> AddTaskItemAsync(TaskItem task)
        {
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                using (var cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    assgnd_emp_id.Value = task.AssignedByEmployeeId ?? (object)DBNull.Value;
        ...
        public async Task<bool> UpdateTaskItemOwnershipAsync(TaskItem task)
        {
            int rows = 0;
            StringBuilder sb = new StringBuilder();
            sb.Append("UPDATE public.wsp_tsk_itms SET tsk_itm_ds=@tsk_itm_ds, ");
            sb.Append("tsk_itm_inf=@tsk_itm_inf, wki_fdr_id=null, ");
            sb.Append("tsk_owner_id=@tsk_owner_id, prgs_stts=@prgs_stts, ");
            sb.Append("exp_start_dt=@exp_start_dt, act_start_dt=@act_start_dt, ");
            sb.Append("exp_due_dt=@exp_due_dt, act_due_dt=@act_due_dt, ");
            sb.Append("unit_id=@unit_id, dept_id=@dept_id, loc_id=@loc_id, ");
            sb.Append("assgnd_emp_id=@assgnd_emp_id, assigned_dt=@assigned_dt, ");
        ...
        #region Delegated Items Action Methods
        public async Task<long> AddDelegationAsync(DelegatedTaskItem task)
        {
            long inserted_row_id = 0;
            StringBuilder sb = new StringBuilder();
            sb.Append("INSERT INTO public.wsp_tsk_delg(tsk_itm_id, frm_emp_id, ");
            sb.Append("to_emp_id, tsk_delg_dt) VALUES (@tsk_itm_id, ");
            sb.Append("@frm_emp_id, @to_emp_id, @tsk_delg_dt) ");
            sb.Append("RETURNING tsk_delg_id; ");
            string query = sb.ToString();
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                await conn.OpenAsync();
                using (var cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    var tsk_delg_dt = cmd.Parameters.Add("@tsk_delg_dt", NpgsqlDbType.Timestamp);
                    cmd.Prepare();
                    tsk_itm_id.Value = task.Id;
                    frm_emp_id.Value = task.DelegatedByEmployeeId;
                    to_emp_id.Value = task.DelegatedToEmployeeId;
                    tsk_delg_dt.Value = task.DelegatedTime;
        ...
        public async Task<bool> UpdateDelegationStatusAsync(long taskDelegationId )
        {
            int rows = 0;
            StringBuilder sb = new StringBuilder();
            sb.Append("UPDATE public.wsp_tsk_delg SET is_re_assgn=true,  ");
            sb.Append("dt_re_assgn=@dt_re_assgn ");
            sb.Append("WHERE (tsk_delg_id=@tsk_delg_id);");
            string query = sb.ToString();
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                await conn.OpenAsync();
                ...
                using (var cmd = new NpgsqlCommand(query, conn))
                {
                    var tsk_delg_id = cmd.Parameters.Add("@tsk_delg_id", NpgsqlDbType.Bigint);
                    var dt_re_assgn = cmd.Parameters.Add("@dt_re_assgn", NpgsqlDbType.Timestamp);
                    cmd.Prepare();
                    tsk_delg_id.Value = taskDelegationId;
                    dt_re_assgn.Value = DateTime.Now;
                    rows = await cmd.ExecuteNonQueryAsync();
                }
                await conn.CloseAsync();
            }
        ...
        public async Task<DelegatedTaskItem> GetDelegatedTaskItemByDelegationIdAsync(long taskDelegationId)
        {
            ...
            sb.Append("WHERE (d.tsk_delg_id=@tsk_delg_id); ");
            string query = sb.ToString();
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                await conn.OpenAsync();
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdAsync(string delegatedByEmployeeId)
        {
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    var frm_emp_id = cmd.Parameters.Add("@frm_emp_id", NpgsqlDbType.Text);
                    await cmd.PrepareAsync();
                    frm_emp_id.Value = delegatedByEmployeeId;
                    using (var reader = await cmd.ExecuteReaderAsync())
                        while (await reader.ReadAsync())
                        {
                            delegatedTaskList.Add(new DelegatedTaskItem
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnProgressStatusIdAsync(string delegatedByEmployeeId, int progressStatusId)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            StringBuilder sb = new StringBuilder();
            sb.Append("SELECT t.tsk_itm_id, t.tsk_itm_no, t.tsk_itm_ds, t.tsk_itm_inf, t.wki_fdr_id, ");
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    await cmd.PrepareAsync();
                    frm_emp_id.Value = delegatedByEmployeeId;
                    prgs_stts.Value = progressStatusId;
                    using (var reader = await cmd.ExecuteReaderAsync())
                        while (await reader.ReadAsync())
                        {
                            delegatedTaskList.Add(new DelegatedTaskItem
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnProgressStatusIdnAssignedDateAsync(string delegatedByEmployeeId, int progressStatusId, DateTime fromDate, DateTime toDate)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            string from_date = fromDate.ToString("yyyy-MM-dd HH:mm:ss");
            string to_date = toDate.ToString("yyyy-MM-dd HH:mm:ss");
            StringBuilder sb = new StringBuilder();
            sb.Append("SELECT t.tsk_itm_id, t.tsk_itm_no, t.tsk_itm_ds, t.tsk_itm_inf, t.wki_fdr_id, ");
            sb.Append("t.mst_tsk_id, t.prj_no, t.prg_no, t.prg_dt, t.tsk_owner_id, t.assgnd_emp_id, ");
            sb.Append("t.assigned_dt, t.tsk_itm_stg, t.prgs_stts, t.apprv_stts, t.approved_dt, ");
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    var frm_emp_id = cmd.Parameters.Add("@frm_emp_id", NpgsqlDbType.Text);
                    var prgs_stts = cmd.Parameters.Add("@prgs_stts", NpgsqlDbType.Integer);
                    var dt_frm = cmd.Parameters.Add("@dt_frm", NpgsqlDbType.Text);
                    var dt_to = cmd.Parameters.Add("@dt_to", NpgsqlDbType.Text);
                    await cmd.PrepareAsync();
                    frm_emp_id.Value = delegatedByEmployeeId;
                    prgs_stts.Value = progressStatusId;
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnAssignedDateAsync(string delegatedByEmployeeId, DateTime fromDate, DateTime toDate)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            string from_date = fromDate.ToString("yyyy-MM-dd HH:mm:ss");
            string to_date = toDate.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        //===================== Get By Delegated By Employee And Delegated To Employee Id ==========================//
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnDelegatedToEmployeeIdAsync(string delegatedByEmployeeId, string delegatedToEmployeeId)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            StringBuilder sb = new StringBuilder();
            sb.Append("SELECT t.tsk_itm_id, t.tsk_itm_no, t.tsk_itm_ds, t.tsk_itm_inf, t.wki_fdr_id, ");
            ...
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    await cmd.PrepareAsync();
                    frm_emp_id.Value = delegatedByEmployeeId;
                    to_emp_id.Value = delegatedToEmployeeId;
                    using (var reader = await cmd.ExecuteReaderAsync())
                        while (await reader.ReadAsync())
                        {
                            delegatedTaskList.Add(new DelegatedTaskItem
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnDelegatedToEmployeeIdnProgressStatusIdAsync(string delegatedByEmployeeId, string delegatedToEmployeeId, int progressStatusId)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            StringBuilder sb = new StringBuilder();
            sb.Append("SELECT t.tsk_itm_id, t.tsk_itm_no, t.tsk_itm_ds, t.tsk_itm_inf, t.wki_fdr_id, ");
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnDelegatedToEmployeeIdnProgressStatusIdnAssignedDateAsync(string delegatedByEmployeeId, string delegatedToEmployeeId, int progressStatusId, DateTime fromDate, DateTime toDate)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            string from_date = fromDate.ToString("yyyy-MM-dd HH:mm:ss");
            string to_date = toDate.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        public async Task<List<DelegatedTaskItem>> GetDelegatedTaskItemsByDelegatedByEmployeeIdnDelegatedToEmployeeIdnAssignedDateAsync(string delegatedByEmployeeId, string delegatedToEmployeeId, DateTime fromDate, DateTime toDate)
        {
            List<DelegatedTaskItem> delegatedTaskList = new List<DelegatedTaskItem>();
            string from_date = fromDate.ToString("yyyy-MM-dd HH:mm:ss");
            string to_date = toDate.ToString("yyyy-MM-dd HH:mm:ss");
        ...
        public async Task<bool> DeleteFolderSubmissionsByToEmployeeIdAsync(string toEmployeeId)
        {
            ...
            StringBuilder sb = new StringBuilder();
            sb.Append("DELETE FROM public.wsp_fdr_sbms ");
            sb.Append("WHERE (to_emp_id = @to_emp_id) ");
            sb.Append("AND (is_xtn = true);");
            string query = sb.ToString();
            using (var conn = new NpgsqlConnection(_config.GetConnectionString("PortalConnection")))
            {
                await conn.OpenAsync();
        ...
        public async Task<List<TaskEvaluationDetail>> GetTaskEvaluationDetailsByTaskFolderIdAsync(long taskFolderId)
        {
            List<TaskEvaluationDetail> taskEvaluationDetails = new List<TaskEvaluationDetail>();
            StringBuilder sb = new StringBuilder();
            ...
            sb.Append("FROM public.wsp_eval_dtl d ");
            sb.Append("INNER JOIN public.wsp_tsk_itms i ON i.tsk_itm_id = d.tsk_itm_id ");
            sb.Append("WHERE (d.wki_fdr_id = @wki_fdr_id) ");
            sb.Append("ORDER BY d.tsk_itm_id; ");
        ...
        public async Task<List<TaskEvaluationSummary>> GetTaskEvaluationSummaryByTaskOwnerIdAsync(string taskOwnerId, DateTime? fromDate = null, DateTime? toDate = null)
        {
            ...
            sb.Append("ROUND((s.average_quality_score * 100)/3, 2) AS percentage_quality_score, ");
                    ...
                    using (var reader = await cmd.ExecuteReaderAsync())
                        while (await reader.ReadAsync())
                        {
                            taskEvaluationSummaries.Add(new TaskEvaluationSummary
                            {
                                ...
                                PercentageAverageQualityScore = reader["percentage_quality_score"] == DBNull.Value ? 0.00M : (decimal)reader["percentage_quality_score"],
                            });
                        }
                }
                await conn.CloseAsync();
        ...
        public async Task<List<TaskEvaluationScores>> GetTaskEvaluationScoresByUnitIdnLocationGroupIdAsync(int locationGroupId, int unitId, DateTime? fromDate = null, DateTime? toDate = null)
        {
            List<TaskEvaluationScores> taskEvaluationScores = new List<TaskEvaluationScores>();
            DateTime from_date = fromDate ?? DateTime.Now.AddMonths(-3);
            DateTime to_date = toDate ?? DateTime.Now;
            ...
            sb.Append("(SELECT fullname FROM public.gst_prsns WHERE id = d.tsk_owner_id) as tsk_owner_nm ");
            sb.Append("FROM public.wsp_eval_dtl d ");
            sb.Append("WHERE (d.unit_id = @unit_id) AND (d.loc_id IN ");
            sb.Append("(SELECT loc_id FROM public.gst_loc_grplocs ");
        ...
        public async Task<List<TaskEvaluationScores>> GetTaskEvaluationScoresByDepartmentIdnLocationGroupIdAsync(int locationGroupId, int deptId, DateTime? fromDate = null, DateTime? toDate = null)
        {
            List<TaskEvaluationScores> taskEvaluationScores = new List<TaskEvaluationScores>();
            DateTime from_date = fromDate ?? DateTime.Now.AddMonths(-3);
            DateTime to_date = toDate ?? DateTime.Now;
            ...
            sb.Append("(SELECT fullname FROM public.gst_prsns WHERE id = d.tsk_owner_id) as tsk_owner_nm ");
            sb.Append("FROM public.wsp_eval_dtl d ");
            sb.Append("WHERE (d.dept_id = @dept_id) AND (d.loc_id IN ");
            sb.Append("(SELECT loc_id FROM public.gst_loc_grplocs ");
            sb.Append("WHERE loc_grp_id = @loc_grp_id)) ");
            sb.Append("AND (d.eval_dt >= @dt_frm) AND (d.eval_dt <= @dt_to) ");
            sb.Append("GROUP BY d.loc_id, d.dept_id, d.tsk_owner_id, tsk_owner_nm ");
        ...
        //==== Get By Location Id & Location Group Id ===//
        ...
        public async Task<List<TaskEvaluationScores>> GetTaskEvaluationScoresByLocationGroupIdAsync(int locationGroupId, DateTime? fromDate = null, DateTime? toDate = null)
        {
            List<TaskEvaluationScores> taskEvaluationScores = new List<TaskEvaluationScores>();
            DateTime from_date = fromDate ?? DateTime.Now.AddMonths(-3);
            DateTime to_date = toDate ?? DateTime.Now;
            ...
            sb.Append("(SELECT fullname FROM public.gst_prsns WHERE id = d.tsk_owner_id) as tsk_owner_nm ");
            sb.Append("FROM public.wsp_eval_dtl d ");
            sb.Append("WHERE (d.loc_id IN (SELECT loc_id FROM public.gst_loc_grplocs ");
            sb.Append("WHERE loc_grp_id = @loc_grp_id) ");
            sb.Append("AND (d.eval_dt >= @dt_frm) ");
            sb.Append("AND (d.eval_dt <= @dt_to) ");
            sb.Append("GROUP BY d.loc_id, d.tsk_owner_id, tsk_owner_nm ");
