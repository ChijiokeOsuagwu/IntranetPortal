                    ...
                    using (var reader = await cmd.ExecuteReaderAsync())
                        while (await reader.ReadAsync())
                        {
                            assetUsages.Add(new AssetUsage()
                            {
                                ...
                                CheckedInCondition = reader["chk_in_cnd"] == DBNull.Value ? AssetCondition.InGoodCondition : (AssetCondition)reader["chk_in_cnd"],
                                ...
                                CheckOutCondition = reader["chk_out_cnd"] == DBNull.Value ? AssetCondition.InGoodCondition : (AssetCondition)reader["chk_out_cnd"],
                ...
                using (NpgsqlCommand cmd = new NpgsqlCommand(query, conn))
                {
                    ...
                    using (var reader = await cmd.ExecuteReaderAsync())
                        while (await reader.ReadAsync())
                        {
                            ...
                            assetUsage.CheckedInCondition = reader["chk_in_cnd"] == DBNull.Value ? AssetCondition.InGoodCondition : (AssetCondition)reader["chk_in_cnd"];
                            ...
                            assetUsage.CheckOutCondition = reader["chk_out_cnd"] == DBNull.Value ? AssetCondition.InGoodCondition : (AssetCondition)reader["chk_out_cnd"];
